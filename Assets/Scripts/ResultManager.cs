...
public class ResultManager : MonoBehaviour
{
    ...
    {
        string esctext = UnityWebRequest.EscapeURL($@"{ScoreData.Instance.title}をプレイ！
ランク: {getRankText(ScoreData.Instance.score)}
スコア: {ScoreData.Instance.score}
https://junnetworks.github.io/BrailleBeatWebGL/");
        string esctag = UnityWebRequest.EscapeURL("BrailleBeat");
